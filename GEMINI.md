...
This is a Next.js 14 (App Router) project for a circular-economy portal called "EcoHub Kosova". The application is built with PNPM, TypeScript, Tailwind CSS, and shadcn/ui. It uses Supabase for authentication and data storage. The primary language of the application is Albanian.
