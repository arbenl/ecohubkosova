...
export default function MarketplaceV2Client({
    locale,
    user,
}: MarketplaceV2ClientProps) {
                        ...
                        <p className="text-sm text-muted-foreground">
                            {locale === "sq" ? (
                                <>
                                    ...
                                    {pagination.totalCount === 1 ? "ofertë" : "oferta"} të gjetura
                                </>
                            ) : (
                                <>
                                    {pagination.totalCount}{" "}
                                    {pagination.totalCount === 1 ? "listing" : "listings"} found
                                </>
                            )}
                        </p>
                    </div>
