...
```html
rounded-full bg-emerald-600 px-5 py-2 text-sm font-semibold text-white hover:bg-emerald-700
...
```html
rounded-full border border-gray-300 px-5 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50
```

**Tertiary (Link)**:

```html
text-emerald-700 font-medium hover:text-emerald-800 underline-offset-2 hover:underline
```
...
_Generated via MCP-first workflow with comprehensive code inspection, build validation, and zero business logic changes._
